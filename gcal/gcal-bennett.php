...
if($display_month != 0)
{
    $start_str = "+" . ($display_month * 30) . " days";
}    

$end_str = "+" . (($display_month * 30) + 30) . " days";


$now      = new DateTime($start_str);
$nextmonth = new DateTime($end_str);

$start = $now->getTimestamp();
$end   = $nextmonth->getTimestamp();
...
//            echo "<hr>";
    ...
    echo "<a class='btn btn-primary btn-sm' href='" . "?month=";
    echo $next_month;
    echo "'>Next month</a>";
    echo '<div>';
...
function display_parsed_events_day($formatted_events)
{
    ...
    $next_month = $display_month + 1;
    echo '<hr><div class="text-center wow fadeInUp">';
    echo "<a class='btn btn-primary btn-sm' href='/gcal/?month=";
    echo $next_month;
    echo "'>Next month</a>";
    echo '<div>';
