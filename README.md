...
| PHP | 8.4 (local), 8.3 (production) |
| Database | MySQL (local), MariaDB 10.6 (production) |
<!-- /macman:software-versions -->
...
<table>
<tr><th>Theme</th><th>Version</th><th>Role</th></tr>
<tr><td rowspan="2">AdminLTE</td><td>2.4.2 (skin-blue-light)</td><td>admin</td></tr>
<tr><td colspan="2"><em>CI3 uses AdminLTE 2.x directly (no Composer package). Cannot upgrade to 3.x without Laravel.</em></td></tr>
<tr><td>Canvas White</td><td>6.0.5.1</td><td>frontend</td></tr>
<tr><td rowspan="2">Bootstrap</td><td>3.3.7</td><td>frontend</td></tr>
<tr><td colspan="2"><em>Bundled with AdminLTE 2.x. Locked to Bootstrap 3 while on AdminLTE 2.</em></td></tr>
</table>
<!-- /macman:themes -->
...
- **Homepage** — featured track audio player, hero section, and upcoming gig carousel
