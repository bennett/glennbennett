							...
							<ul class="menu-container">
                                ...
                                <li class="menu-item"><a class="menu-link" href="#"><div>Albums</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="/site/album"><div>Live At The Guitar Merchant</div></a></li>

									</ul>
								</li>
								<li class="menu-item"><a class="menu-link" href="#"><div>Videos</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="/site/vids"><div>All Songs</div></a></li>
										<li class="menu-item"><a class="menu-link" href="/site/vids/1"><div>Original Songs</div></a></li>
										<li class="menu-item"><a class="menu-link" href="/site/vids/2"><div>Cover Songs</div></a></li>
					
									</ul>
								</li>
                                <!--li class="menu-item"><a class="menu-link" href="/cal"><div>Performances</div></a></li>
		...
		<section id="slider" class="slider-element swiper_wrapper min-vh-60 min-vh-md-100 include-header" style="background: #131722;" data-effect="fade" data-loop="true" data-speed="1000">
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
                   ...
                   <p class="d-none d-md-block">
                    <?php echo $featured->featured_track->blurb; ?>
                   </p>
...
<strong>Thursday</strong> - <small>July 21
</small>
</button>
</div>

<div class="dark">
<h2>Ventura Harbor Village @ Copa Cubana</h2>


<ul class="entry-meta clearfix">
<li><i class="icon-calendar"></i> Thursday - July 21, 2022</a></li>
<li><i class="icon-time"></i> 1:00 pm - 4:00 pm</a></li>

</ul>
<a href="/cal" class="btn btn-danger">More Information</a>
</div>
                            </div>
                            </div>
						</div>
						...
						<div class="oc-item">
							<div class="ievent clearfix">
								...
								<div class="entry-c">
									<div class="entry-title">
										<h2><a href="#">Inventore voluptates velit totam ipsa</a></h2>
									</div>
									<ul class="entry-meta clearfix">
...
<!--=================-->
					...
					<div class="heading-block topmargin bottommargin-sm border-0 dark">
						...
						<span>Original And Cover Songs.</span>
					</div>
					...
					<div class="row topmargin-lg clearfix">
						<div class="col-lg-6">
							<div class="heading-block border-0 dark" style="margin-bottom: 15px;">
								...
								<span>Some of the origial songs by Glenn Bennett.</span>
							</div>
						...
						<div class="col-lg-6">
							<div class="heading-block border-0 dark" style="margin-bottom: 15px;">
								<h3>Cover Tracks</h3>
								<span>cover songs performed by Glenn Bennett.</span>
							</div>
							<div class="songs-lists-wrap">
                             <?php
                                $i = 1;
				...
				<div class="container clearfix">
					...
					<div class="row justify-content-between col-mb-30">
						<div class="col-12 col-lg-auto text-center text-lg-left">
							Copyrights &copy; 2020 All Rights Reserved by Glenn L. Bennett.
						</div>
