...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://2c91ae0d.sibforms.com/serve/MUIFAHkM_THU4q-NJKJAXYpfS4ijNMLBQ9wWMU6E8InGjBmrjUfU-CSzHxlHpNIS1ozI4AgQvhJYp1gv91xYFgZG0s5OtuIIAyYfvTcsoqq9yKbmotF71bxzNyvptMcKvFYkjLz-7nNeUAcCQp8fhUq3Dt5dTMI1mqdN9nYaoVRiWjPTekAR1q9MdIwhd6ag-6ZNzO1QhVbk2z0d" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:Helvetica, sans-serif; color:#3c4858;" for="LASTNAME">Enter your LASTNAME</label>
        ...
        <div style="padding: 8px 0;">
          <div class="g-recaptcha-v3" data-sitekey="6LdMeXAcAAAAAKPekAQnT0dloUqXG47mq8XV2Drh" style="display: none"></div>
        </div>
        <div style="padding: 8px 0;">
