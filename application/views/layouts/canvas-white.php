...
[css]
	...
	<!-- Document Title
	============================================= -->
	<title>Glenn Bennett | Music</title>
    <?php 
    if( isset($og) )
    { 
        echo $og;
    ...
    {
    ?>    
<meta property="og:title" content="Glenn Bennett | Music" />
<meta property="og:url" content="https://glennbennett.com/cal" />
<meta property="og:description" content="Glenn Bennett | Music" />
<meta property="og:type" content="article" />
<meta property="og:image" content="https://glennbennett.com/imgs/640-480.jpg" />
    <?php
    }
    ?>
...
<!-- Header
		============================================= -->
		<header id="header" class="full-header transparent-header  no-sticky header-size-md">
			<div id="header-wrap">
				<div class="container">
			...
			<div id="copyrights" style="color: #444;">
				<div class="container clearfix">
					...
					<div class="row justify-content-center mb-3">
						<div class="col-auto">
							<a href="/" class="text-white-50 mx-2">Home</a>
					...
					<div class="row justify-content-between col-mb-30">
						<div class="col-12 col-lg-auto text-center text-lg-left">
							Copyrights &copy; 2020-<?php echo date("Y"); ?> All Rights Reserved by Glenn L. Bennett.
						</div>
						...
						<div class="col-12 col-lg-auto text-center text-lg-right">
                            ...
                            <a target="_blank" href="https://www.instagram.com/glennlbennett/" class="social-icon inline-block si-small si-borderless si-instagram">
